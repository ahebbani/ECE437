...
HD_PWD='/home/ecegridfs/a/437mg108/ece437/pipelinePartner/processors-team/build/system_fpga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log system_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source system_fpga.tcl -notrace
