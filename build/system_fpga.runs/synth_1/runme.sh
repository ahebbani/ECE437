...
HD_PWD='/home/ecegridfs/a/437mg108/ece437/pipelinePartner/processors-team/build/system_fpga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_fpga.tcl
