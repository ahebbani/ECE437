...
HD_PWD='/home/ecegridfs/a/437mg108/ece437/pipelinePartner/processors-team/build/system_fpga.runs/mem_debug_vio_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mem_debug_vio.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mem_debug_vio.tcl
