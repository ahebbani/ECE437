...
interface mem_wb_if;
  ...
  logic pipe_ctrl, RegWEN_in, RegWEN_out, halt_out, halt_in;
  logic [31:0] inst_in, inst_out;

  // control_unit ports
  modport memwb (
	input pipe_ctrl, inst_in, halt_in, dhit, ihit, pc_in, imm_in, MemtoReg_in, dmemload_in, alu_out_in, rd_in, RegWEN_in,
  ...
  modport tb (
	...
	output pipe_ctrl, inst_in, halt_in, dhit, ihit, pc_in, imm_in, MemtoReg_in, dmemload_in, alu_out_in, rd_in, RegWEN_in
  );
endinterface
