...
interface ex_mem_if;
  ...
  word_t pc_out, pc_in;
  word_t dmemload, imm_out, imm_in, rdat1_out, rdat1_in, rdat2_out, rdat2_in, alu_out_out, alu_out_in;
  ...
  modport exmem (
	...
	output dmemload, inst_out, dmemREN, dmemWEN, pc_out, alu_out_out, rdat1_out, rdat2_out, imm_out, dREN_out, dWEN_out, branchPCand_out, branchPCadder_out, jumpPCsrc_out, jumpPCadder_out, MemtoReg_out, rd_out,RegWEN_out, halt_out
  );
  // control_unit tb
  modport tb (
	input dmemload, inst_out, dmemREN, dmemWEN, pc_out, alu_out_out, rdat1_out, rdat2_out, imm_out, dREN_out, dWEN_out, branchPCand_out, branchPCadder_out, jumpPCsrc_out, jumpPCadder_out, MemtoReg_out, rd_out,RegWEN_out,
