...
interface ex_mem_if;
  ...
  // control_unit ports
  modport exmem (
	input pipe_ctrl, inst_in, stall, dhit, ihit, alu_out_in, pc_in, rdat1_in, rdat2_in, imm_in, dREN_in, dWEN_in, branchPCand_in, branchPCadder_in, jumpPCsrc_in, jumpPCadder_in, MemtoReg_in, rd_in,RegWEN_in, halt_in,
