...
interface id_ex_if;
  ...
  // control_unit ports
  modport idex (
	input pipe_ctrl, rs1_in, rs2_in, stall, flush, ihit, dhit, pc_in, rdat1_in, rdat2_in, imm_in, aluop_in, ALUSrc1_in, ALUSrc2_in, dREN_in, dWEN_in, branchPCSrc_in, jumpPCsrc_in, MemtoReg_in, rd_in,RegWEN_in, halt_in, inst_in,
