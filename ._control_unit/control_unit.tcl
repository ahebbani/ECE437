...
if ([project_exists control_unit]) {
  project_open -revision control_unit control_unit
} else {
  project_new -revision control_unit control_unit
}
set_global_assignment -name PROJECT_OUTPUT_DIRECTORY /home/ecegridfs/a/437mg063/ece437/processors/._control_unit
...
set_global_assignment -name SDC_FILE control_unit.sdc
