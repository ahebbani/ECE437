...
if ([project_exists register_file]) {
  project_open -revision register_file register_file
} else {
  project_new -revision register_file register_file
}
set_global_assignment -name PROJECT_OUTPUT_DIRECTORY /home/ecegridfs/a/437mg063/ece437/processors/._register_file
...
set_global_assignment -name SDC_FILE register_file.sdc
